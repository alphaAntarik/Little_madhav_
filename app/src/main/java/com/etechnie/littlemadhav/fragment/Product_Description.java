...
import com.etechnie.littlemadhav.colours_adapter;
import com.etechnie.littlemadhav.datamodel_colours_rv;
...
import com.etechnie.littlemadhav.adapters.ProductReviewsAdapter;
import com.etechnie.littlemadhav.app.App;
import com.etechnie.littlemadhav.customs.DialogLoader;
import com.etechnie.littlemadhav.customs.DividerItemDecoration;
import com.etechnie.littlemadhav.models.product_model.GetAllProducts;
import com.etechnie.littlemadhav.models.product_model.GetStock;
import com.etechnie.littlemadhav.models.product_model.Option;
import com.etechnie.littlemadhav.models.product_model.ProductStock;
import com.etechnie.littlemadhav.models.product_model.Value;
import com.etechnie.littlemadhav.models.ratings.GetRatings;
import com.etechnie.littlemadhav.models.ratings.GiveRating;
import com.etechnie.littlemadhav.models.ratings.ProductReviews;
import com.etechnie.littlemadhav.network.APIClient;
import com.etechnie.littlemadhav.utils.Utilities;
import com.etechnie.littlemadhav.activities.Login;
import com.etechnie.littlemadhav.adapters.ProductAttributesAdapter;
import com.etechnie.littlemadhav.constant.ConstantValues;
import com.etechnie.littlemadhav.models.cart_model.CartProduct;
import com.etechnie.littlemadhav.models.cart_model.CartProductAttributes;
import com.etechnie.littlemadhav.models.product_model.Attribute;
import com.etechnie.littlemadhav.models.product_model.Image;
...
public class Product_Description extends Fragment implements colours_adapter.ItemClickListener_colours {
    ...
    private List<datamodel_colours_rv> list_colours= new ArrayList<>();
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  MainActivity.actionBarDrawerToggle.setDrawerIndicatorEnabled(false);
       ...
       // noInternetDialog.show();
        ...
        ChooseColour = (Button) rootView.findViewById(R.id.choose_colour_button);
...
//        buildListData();
    ...
    private  void initRecyclerView(View view){
        rv = view.findViewById(R.id.colours_rv);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(RecyclerView.HORIZONTAL);
        rv.setLayoutManager(linearLayoutManager);

        colours_adapter adapter = new colours_adapter(list_colours,  this);
        rv.setAdapter(adapter);
    }
    private void buildListData(){

        for(int i=1;i<=10;i++){
            datamodel_colours_rv d=new datamodel_colours_rv();
            d.setColour_name("colour name");

            d.setColour("https://img.freepik.com/free-psd/fashion-poster-template_23-2148838187.jpg?w=826&t=st=1663390937~exp=1663391537~hmac=c6972505169d67aca95ddc46f04e9871e9e1a4f13f0138cac94269836e83f5ec");
    ...
    private void setProductDetails(final ProductDetails productDetails) {
        ...
        image_.setImage(productDetails.getProductsImage());
        image_.setName(productDetails.getProductsName());
        itemImages.add(image_);
        ...
        //price_old.setText(productDetails.getProductsPrice());
        //price_new.setText(productDetails.getDiscountPrice());
...
//
        ...
        productFinalPrice = productDetails.getProductsPrice();
...
//                    if (productDetails.getProductsQuantity() > 0) {
                        ...
                        productDetails.setProductsPrice((int)productBasePrice);
