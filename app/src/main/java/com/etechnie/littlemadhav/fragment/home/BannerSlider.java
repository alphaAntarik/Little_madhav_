...
public class BannerSlider extends Fragment implements BaseSliderView.OnSliderClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_banner_slider, container, false);
        ...
        b.setImage("https://img.freepik.com/free-psd/horizontal-banner-online-fashion-sale_23-2148585404.jpg");

        b.setTitle("Banner Image 1");
        bannerImages.add(b);
        b= new BannerDetails();
        b.setImage("https://img.freepik.com/free-psd/fashion-banner-template_23-2148509060.jpg");

        b.setTitle("Banner Image 2");
        bannerImages.add(b);
