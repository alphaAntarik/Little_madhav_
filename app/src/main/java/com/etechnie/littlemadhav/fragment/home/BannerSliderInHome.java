...
public class BannerSliderInHome extends Fragment implements BaseSliderView.OnSliderClickListener {
    View rootView;
    ...
    public BannerSliderInHome(List<BannerDetails> bannerImages, List<CategoryDetails> allCategoriesList) {
