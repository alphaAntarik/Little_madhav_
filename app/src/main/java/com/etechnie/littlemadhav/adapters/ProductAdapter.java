...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (position != productList.size()) {
           ...
           // final String discount = Utilities.checkDiscount(product.getProductsPrice(), product.getProductsPrice());
            final String discount =null;
            if (discount != null) {
                // Set Product's Price
...
//            }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        TextView product_title, product_category, product_price_old, product_price_new, product_tag_discount_text, product_description_title_;
    ...
    private void addProductToCart(ProductDetails product) {
        ...
        final String discount = Utilities.checkDiscount(String.valueOf(product.getProductsPrice()), String.valueOf(product.getDiscountPrice()));
        
        // Get Product's Price based on Discount
        if (discount != null) {
            product.setIsSaleProduct("1");
            productBasePrice = (product.getDiscountPrice());
        } else {
            product.setIsSaleProduct("0");
            productBasePrice = (product.getProductsPrice());
        }
        ...
        product.setProductsPrice((int)productBasePrice);
