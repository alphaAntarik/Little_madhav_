package com.etechnie.littlemadhav.models.product_model;
...
import com.etechnie.littlemadhav.models.ratings.RatingDataList;
...
public class ProductDetails implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel_out, int flags) {
        ...
        parcel_out.writeInt(productsPrice);
        parcel_out.writeInt(discountPrice);
    ...
    protected ProductDetails(Parcel parcel_in) {
        ...
        this.productsPrice = parcel_in.readInt();
        this.discountPrice = parcel_in.readInt();
