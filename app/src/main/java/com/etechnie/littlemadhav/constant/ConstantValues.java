package com.etechnie.littlemadhav.constant;
...
public class ConstantValues {
    ...
    public static final String ECOMMERCE_URL = "http://little.etechnie.com/";
    ...
    public static String NAVIGATION_STYLE = "bottom";                             // "bottom" for bottom navigation. "side" for side navigation.
