...
import com.etechnie.littlemadhav.models.address_model.AddressData;
import com.etechnie.littlemadhav.models.address_model.Countries;
import com.etechnie.littlemadhav.models.address_model.Zones;
...
import com.etechnie.littlemadhav.models.contact_model.ContactUsData;
...
import com.etechnie.littlemadhav.models.filter_model.get_filters.FilterData;
import com.etechnie.littlemadhav.models.googleMap.GoogleAPIResponse;
import com.etechnie.littlemadhav.models.language_model.LanguageData;
...
import com.etechnie.littlemadhav.models.news_model.all_news.NewsData;
import com.etechnie.littlemadhav.models.news_model.news_categories.NewsCategoryData;
import com.etechnie.littlemadhav.models.pages_model.PagesData;
import com.etechnie.littlemadhav.models.pay_tm.Checksum;
import com.etechnie.littlemadhav.models.product_model.GetAllProducts;
import com.etechnie.littlemadhav.models.coupons_model.CouponsData;
import com.etechnie.littlemadhav.models.payment_model.PaymentMethodsData;
...
import com.etechnie.littlemadhav.models.shipping_model.PostTaxAndShippingData;
import com.etechnie.littlemadhav.models.order_model.OrderData;
import com.etechnie.littlemadhav.models.payment_model.GetBrainTreeToken;
import com.etechnie.littlemadhav.models.order_model.PostOrder;
import com.etechnie.littlemadhav.models.product_model.ProductData;
import com.etechnie.littlemadhav.models.search_model.SearchData;
import com.etechnie.littlemadhav.models.shipping_model.ShippingRateData;
import com.etechnie.littlemadhav.models.uploadimage.UploadImageModel;
...
public interface APIRequests {
    ...
    @POST("DataAPI/getAllItem")
    Call<ResponseData<List<ProductDetails>>> getAllProducts(@Body GetAllProducts getAllProducts);
    ...
    @POST("DataAPI/getAllBrand")
    Call<ResponseData<List<Brand_Model>>> getAllBrands();

    @POST("DataAPI/getAllCategory")
    Call<ResponseData<List<Category_model>>> getAllCategory();
    @POST("DataAPI/processLogin")
