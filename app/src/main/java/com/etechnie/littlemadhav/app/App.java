package com.etechnie.littlemadhav.app;
...
import com.etechnie.littlemadhav.databases.DB_Handler;
import com.etechnie.littlemadhav.databases.DB_Manager;
...
public class App extends MultiDexApplication {
    ...
    private List<Brand_Model> Brand_list = new ArrayList<>();
    ...
    public List<Brand_Model> getBrand_list() {
        return Brand_list;
    }

    public void setBrand_list(List<Brand_Model> brand_list) {
        Brand_list = brand_list;
    }

    public List<Category_model> getCategory_list() {
        return Category_list;
    }
    public void setCategory_list(List<Category_model> category_list) {
    ...
    public void setProduct_list(List<ProductData> productlist) {
